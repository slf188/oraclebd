...
insert into supervisor values ('SUP-1', 'Moyota', 'Ivan', 'Doctor');
insert into supervisor values ('SUP-2', 'Santillan', 'Patricio', 'No Doctor');
...
insert into profesor_investigacion values ('PRF-1', 'INV-1', to_date('01/01/2023', 'dd/mm/yyyy'), to_date('02/01/2023', 'dd/mm/yyyy'));
insert into profesor_investigacion values ('PRF-2', 'INV-2', to_date('03/01/2023', 'dd/mm/yyyy'), to_date('04/01/2023', 'dd/mm/yyyy'));
